...
trait helper
{
    ...
    public function roleCheck($username){
        $role = Account::where('username',$username)->first()->role_id;
        //return 'raka';
    ...
    //Check Cookies
    public function cookiesCheck($username,$token){
    ...
    public function createDate($format){
        $date =date_create();
        $date = date_format($date,$format);
        return $date;
    }

    public function configData($data){
